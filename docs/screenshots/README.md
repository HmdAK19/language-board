...
npx playwright test e2e/documentation.spec.ts --workers=2
```
...
آخرین تولید: ۲۰۲۶-۰۹-۲۳ با Edge روی Windows؛ هر ۶ سناریو موفق بود. نماهای نمونهٔ موبایل و دسکتاپ و هر دو دیالوگ به‌صورت چشمی بررسی شدند.
