...
- مهاجرت دادهٔ قدیمی، اعتبارسنجی ساختار ذخیره‌شده و هشدار خطای ذخیره‌سازی.
...
| [مدل داده و ذخیره‌سازی](docs/data-model.fa.md) | نسخهٔ ۲، reducer، مهاجرت و بازیابی       |
...
جست‌وجو، حذف/تغییر نام واژه و import/export در رابط پیاده‌سازی نشده‌اند. لینک‌های قبلی به ترجمهٔ تکلیف و چک‌لیست ناموجود حذف شده‌اند؛ این مستندات وضعیت کد موجود را توضیح می‌دهند.
